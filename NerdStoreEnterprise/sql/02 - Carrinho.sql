...
CREATE TABLE [CarrinhoItens] (
    ...
    CONSTRAINT [FK_CarrinhoItens_CarrinhoCliente_CarrinhoId] FOREIGN KEY ([CarrinhoId]) REFERENCES [CarrinhoCliente] ([Id]) ON DELETE NO ACTION
);
...
VALUES (N'20201125154824_Carrinho01', N'3.1.8');
